...
public enum FieldInput
{
    ...
    [JsonStringEnumMemberName("text_box")]
    TextBox,

    /// <summary>テキストエリア</summary>
    [JsonStringEnumMemberName("text_area")]
    TextArea,

    /// <summary>ナンバーボックス</summary>
    [JsonStringEnumMemberName("number_box")]
    NumberBox,

    /// <summary>プルダウンリスト</summary>
    [JsonStringEnumMemberName("pull_down")]
    PullDown,

    /// <summary>ラジオボタン</summary>
    [JsonStringEnumMemberName("radio_button")]
    RadioButton,

    /// <summary>チェックボックス</summary>
    [JsonStringEnumMemberName("check_box")]
    CheckBox,
    ...
    [JsonStringEnumMemberName("attach_file")]
    AttachFile,

    /// <summary>顔写真</summary>
    [JsonStringEnumMemberName("face_image")]
    FaceImage,

    /// <summary>計算式</summary>
    [JsonStringEnumMemberName("calc_formula")]
    CalcFormula,
}
