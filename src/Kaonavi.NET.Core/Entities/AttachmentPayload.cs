...
public record AttachmentPayload(string Code, params IReadOnlyList<AttachmentPayloadRecord> Records)
{
    /// <summary>
    ...
    public AttachmentPayload(string code, AttachmentPayloadRecord record)
        : this(code, [record]) { }
}
