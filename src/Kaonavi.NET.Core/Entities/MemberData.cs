...
public record MemberData(
    ...
    string? Mail = null,
    [property: JsonConverter(typeof(BlankDateOnlyConverter))] DateOnly? EnteredDate = default,
    [property: JsonConverter(typeof(BlankDateOnlyConverter))] DateOnly? RetiredDate = default,
    string? Gender = null,
