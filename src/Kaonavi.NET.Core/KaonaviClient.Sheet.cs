...
public partial class KaonaviClient : KaonaviClient.ISheet
{
    ...
    public interface ISheet
    {
        ...
        public ValueTask<IReadOnlyList<SheetData>> ListAsync(
            int id,
        ...
        public ValueTask<int> ReplaceAsync(
            int id,
            IReadOnlyList<SheetData> payload,
            CancellationToken cancellationToken = default
        );
        ...
        public ValueTask<IReadOnlyList<AttachmentInfo>> ListFileAsync(
            int id,
            int customFieldId,
        ...
        /// <param name="cancellationToken"><inheritdoc cref="HttpClient.SendAsync(HttpRequestMessage, CancellationToken)" path="/param[@name='cancellationToken']"/></param>
        /// <returns><inheritdoc cref="TaskProgress" path="/param[@name='Id']"/></returns>
        public ValueTask<int> AddFileAsync(
            int id,
            int customFieldId,
            IReadOnlyList<AttachmentPayload> payload,
            CancellationToken cancellationToken = default
        );
        ...
        /// <param name="cancellationToken"><inheritdoc cref="HttpClient.SendAsync(HttpRequestMessage, CancellationToken)" path="/param[@name='cancellationToken']"/></param>
        /// <returns><inheritdoc cref="TaskProgress" path="/param[@name='Id']"/></returns>
        public ValueTask<int> UpdateFileAsync(
            int id,
            int customFieldId,
            IReadOnlyList<AttachmentPayload> payload,
            CancellationToken cancellationToken = default
    ...
    ValueTask<IReadOnlyList<SheetData>> ISheet.ListAsync(
        int id,
    ...
    )
    {
        ...
        return CallApiAsync(
            new(HttpMethod.Get, $"sheets/{id:D}"),
            "member_data",
            Context.Default.IReadOnlyListSheetData,
            cancellationToken
        );
    }
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="id"/>が0より小さい場合にスローされます。</exception>
    ValueTask<int> ISheet.ReplaceAsync(
        int id,
        IReadOnlyList<SheetData> payload,
        CancellationToken cancellationToken
    )
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="id"/>が0より小さい場合にスローされます。</exception>
    ValueTask<int> ISheet.UpdateAsync(
        int id,
        IReadOnlyList<SheetData> payload,
        CancellationToken cancellationToken
    )
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="id"/>が0より小さい場合にスローされます。</exception>
    ValueTask<int> ISheet.CreateAsync(
        int id,
        IReadOnlyList<SheetData> payload,
        CancellationToken cancellationToken
    )
    ...
    ValueTask<IReadOnlyList<AttachmentInfo>> ISheet.ListFileAsync(
        int id,
        int customFieldId,
    ...
    )
    {
        ...
        string uriString =
            $"sheets/{id:D}/custom_fields/{customFieldId:D}/file{(updatedSince != default ? $"?updated_since={updatedSince:o}" : "")}";
        return CallApiAsync(
            new(HttpMethod.Get, uriString),
            "member_data",
            Context.Default.IReadOnlyListAttachmentInfo,
            cancellationToken
        );
    }
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="id"/>または<paramref name="customFieldId"/>が0より小さい場合にスローされます。</exception>
    ValueTask<int> ISheet.AddFileAsync(
        int id,
        int customFieldId,
        IReadOnlyList<AttachmentPayload> payload,
        CancellationToken cancellationToken
    )
    {
        ...
        return CallTaskApiAsync(
            HttpMethod.Post,
            $"sheets/{id:D}/custom_fields/{customFieldId:D}/file",
            payload,
            "member_data"u8,
            Context.Default.IReadOnlyListAttachmentPayload,
            cancellationToken
        );
    }
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="id"/>または<paramref name="customFieldId"/>が0より小さい場合にスローされます。</exception>
    ValueTask<int> ISheet.UpdateFileAsync(
        int id,
        int customFieldId,
        IReadOnlyList<AttachmentPayload> payload,
        CancellationToken cancellationToken
