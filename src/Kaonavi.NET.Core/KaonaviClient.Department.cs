...
public partial class KaonaviClient : KaonaviClient.IDepartment
{
    ...
    public interface IDepartment
    {
        ...
        public ValueTask<IReadOnlyList<DepartmentTree>> ListAsync(
        ...
        public ValueTask<int> ReplaceAsync(
            IReadOnlyList<DepartmentTree> payload,
            CancellationToken cancellationToken = default
        );
    }
    ...
    /// <inheritdoc/>
    ValueTask<IReadOnlyList<DepartmentTree>> IDepartment.ListAsync(
        CancellationToken cancellationToken
    ) =>
        CallApiAsync(
            new(HttpMethod.Get, "departments"),
            "department_data",
            Context.Default.IReadOnlyListDepartmentTree,
            cancellationToken
        );

    /// <inheritdoc/>
    ValueTask<int> IDepartment.ReplaceAsync(
        IReadOnlyList<DepartmentTree> payload,
        CancellationToken cancellationToken
    ) =>
        CallTaskApiAsync(
