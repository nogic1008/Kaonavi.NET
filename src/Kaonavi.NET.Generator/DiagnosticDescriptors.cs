...
internal static class DiagnosticDescriptors
{
    ...
    private const string HelpLink =
        "https://github.com/nogic1008/Kaonavi.NET/tree/v4.0.0/docs/analyzer/";
    ...
    private static DiagnosticDescriptor Create(
        ...
        new(
            id,
            GetResource($"{id}_Title"),
            GetResource($"{id}_MessageFormat"),
            Category,
            severity,
            isEnabledByDefault,
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor MustBePartial = Create(
        "KAONAVI001",
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor MustBeOuterClass = Create(
        "KAONAVI002",
        DiagnosticSeverity.Warning,
        true
    );
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor MustImplSheetData = Create(
        "KAONAVI003",
        DiagnosticSeverity.Warning,
        true
    );
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor AlreadyImplemented = Create(
        "KAONAVI004",
        DiagnosticSeverity.Warning,
        true
    );
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor MustHaveCustomField = Create(
        "KAONAVI005",
        DiagnosticSeverity.Warning,
        true
    );
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor DuplicateCustomFieldId = Create(
        "KAONAVI006",
        DiagnosticSeverity.Warning,
        true
    );
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor MustHaveGetter = Create(
        "KAONAVI007",
        DiagnosticSeverity.Warning,
        true
    );
