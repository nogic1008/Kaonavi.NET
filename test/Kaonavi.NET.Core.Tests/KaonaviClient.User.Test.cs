...
public sealed partial class KaonaviClientTest
{
    ...
    public sealed class UserTest
    {
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.ListAsync)}() > GET /users をコールする。"
        )]
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.CreateAsync)}(payload) > POST /users をコールする。"
        )]
        ...
        [Test, Category(nameof(HttpMethod.Get))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.ReadAsync)}(-1) > {nameof(ArgumentOutOfRangeException)} をスローする。"
        )]
        ...
        )
        {
            ...
            await Assert
                .That(async () => _ = await sut.User.ReadAsync(-1, cancellationToken))
        ...
        [Test, Category(nameof(HttpMethod.Get))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.ReadAsync)}(1) > GET /users/1 をコールする。"
        )]
        public async Task User_ReadAsync_Calls_GetApi(CancellationToken cancellationToken = default)
        {
            ...
            client.Handler.Verify(
                r => r.Method(HttpMethod.Get).Path($"/users/{userId}"),
                Times.Once
            );
        }
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.UpdateAsync)}(-1, payload) > {nameof(ArgumentOutOfRangeException)} をスローする。"
        )]
        ...
        )
        {
            ...
            var sut = CreateSut(client);
            await Assert
                .That(async () => _ = await sut.User.UpdateAsync(-1, null!, cancellationToken))
                .Throws<ArgumentOutOfRangeException>()
                .WithParameterName("id");
            await Assert.That(client.Handler.Requests).IsEmpty();
        }
        ...
        [Test, Category(nameof(HttpMethod.Patch))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.UpdateAsync)}(1, payload) > PATCH /users/1 をコールする。"
        )]
        ...
        )
        {
            ...
            using var client = Mock.HttpClient(BaseUriString);
            client
                .Handler.OnRequest(req => req.Method(HttpMethod.Patch).Path($"/users/{userId}"))
            ...
            await Assert.That(user).IsNotNull();
            client.Handler.Verify(
                r => r.Method(HttpMethod.Patch).Path($"/users/{userId}"),
                Times.Once
            );
            await Assert
                .That(client.Handler.Requests[0].Body)
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.DeleteAsync)}(-1) > {nameof(ArgumentOutOfRangeException)} をスローする。"
        )]
        ...
        )
        {
            ...
            var sut = CreateSut(client);
            await Assert
                .That(async () => await sut.User.DeleteAsync(-1, cancellationToken))
                .Throws<ArgumentOutOfRangeException>()
                .WithParameterName("id");
            await Assert.That(client.Handler.Requests).IsEmpty();
        }
        ...
        [Test, Category(nameof(HttpMethod.Delete))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.User)}.{nameof(KaonaviClient.User.DeleteAsync)}(1) > DELETE /users/1 をコールする。"
        )]
        ...
        )
        {
            ...
            using var client = Mock.HttpClient(BaseUriString);
            client
                .Handler.OnDelete($"/users/{userId}")
                .RespondWithString("", HttpStatusCode.NoContent);
            ...
            // Assert
            client.Handler.Verify(
                r => r.Method(HttpMethod.Delete).Path($"/users/{userId}"),
                Times.Once
            );
        }
    }
