...
public sealed partial class KaonaviClientTest
{
    ...
    public sealed class EnumOptionTest
    {
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.EnumOption)}.{nameof(KaonaviClient.EnumOption.ListAsync)}() > GET /enum_options をコールする。"
        )]
        ...
        [Test, Category(nameof(HttpMethod.Get))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.EnumOption)}.{nameof(KaonaviClient.EnumOption.ReadAsync)}(-1) > {nameof(ArgumentOutOfRangeException)} をスローする。"
        )]
        ...
        )
        {
            ...
            await Assert
                .That(async () => await sut.EnumOption.ReadAsync(-1, cancellationToken))
        ...
        [Test, Category(nameof(HttpMethod.Get))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.EnumOption)}.{nameof(KaonaviClient.EnumOption.ReadAsync)}(10) > GET /enum_options/10 をコールする。"
        )]
        ...
        )
        {
            ...
            client.Handler.Verify(
                r => r.Method(HttpMethod.Get).Path($"/enum_options/{id}"),
                Times.Once
            );
        }
        ...
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.EnumOption)}.{nameof(KaonaviClient.EnumOption.UpdateAsync)}(-1, payload) > {nameof(ArgumentOutOfRangeException)} をスローする。"
        )]
        ...
        )
        {
            ...
            var sut = CreateSut(client);
            await Assert
                .That(async () => await sut.EnumOption.UpdateAsync(-1, [], cancellationToken))
                .Throws<ArgumentOutOfRangeException>()
                .WithParameterName("id");
            await Assert.That(client.Handler.Requests).IsEmpty();
        }
        ...
        [Test, Category(nameof(HttpMethod.Put))]
        [DisplayName(
            $"{nameof(KaonaviClient)} > {nameof(KaonaviClient.EnumOption)}.{nameof(KaonaviClient.EnumOption.UpdateAsync)}(10, payload) > PUT /enum_options/10 をコールする。"
        )]
        ...
        )
        {
            ...
            // Act
            var sut = CreateSut(client, "token");
            int taskId = await sut.EnumOption.UpdateAsync(
                id,
                [new(1, "社長"), new("本部長"), new(2, "マネージャー")],
                cancellationToken
            );
            ...
            client.Handler.Verify(
                r => r.Method(HttpMethod.Put).Path($"/enum_options/{id}"),
                Times.Once
            );
            await Assert
