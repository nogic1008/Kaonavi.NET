...
#if NET6_0
        static DateTime? ParseDateOrNull(string? value) => DateTime.TryParseExact(value, "yyyy/MM/dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out var date) ? date : null;
#else
